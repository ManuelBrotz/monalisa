...
public class ImageData {
    ...
    public static ImageData read(DataInputStream in) throws IOException {
        ...
        final ImageType type = ImageType.from(rawtype);
    ...
    public static ImageData read(Image image, boolean readData) {
    ...
    public static ImageData read(BufferedImage image, ImageType convertTo) {
        Preconditions.checkNotNull(image, "The parameter 'image' must not be null");
        Preconditions.checkNotNull(convertTo, "The parameter 'convertTo' must not be null");
        final BufferedImage converted = convertTo.convert(image);
